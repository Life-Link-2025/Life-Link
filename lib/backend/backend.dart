...
import 'schema/emergency_requests_record.dart';
import 'schema/userid_record.dart';
...
export 'schema/emergency_requests_record.dart';
export 'schema/userid_record.dart';
export 'schema/userdata_record.dart';

/// Functions to query EmergencyRequestsRecords (as a Stream and as a Future).
Future<int> queryEmergencyRequestsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EmergencyRequestsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EmergencyRequestsRecord>> queryEmergencyRequestsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      EmergencyRequestsRecord.collection,
      EmergencyRequestsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EmergencyRequestsRecord>> queryEmergencyRequestsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
